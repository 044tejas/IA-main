...
![5](https://github.com/044tejas/IA/assets/136159210/f434097f-4ec7-48c8-a3f0-e70025e0bb18))
...
1. Clone this repository to your local machine:
    ...
    ```bash
    git clone https://github.com/044tejas/IA.git
    ```
...
```bash
docker pull tejas428/myvprofileapp
```
## Author

- [Tejas](https://github.com/044tejas)
